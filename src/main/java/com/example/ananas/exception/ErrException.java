...
public enum ErrException {
    ...
    VOUCHER_EXISTED(101,"Mã giảm giá đã tồn tại"),
    VOUCHER_NOT_EXISTED(101,"Mã giảm giá không tồn tại"),
    VOUCHER_ERROR_ARCHIVE(812,"Nhận mã giảm giá bị lỗi"),
    VOUCHER_OUT_OF_DATE(812,"Mã giảm giá hết thời hạn"),
    VOUCHER_NOT_ELIGIBLE(812,"Đơn hàng không đủ điều kiện để áp dụng mã giảm giá"),
    VOUCHER_OUT_OF_STOCK(812,"Mã giảm giá đã hết số lượng sử dụng"),
    VOUCHER_ARCHIVE_EMPTY(822,"Bạn không có mã giảm giá này"),
    VOUCHER_ARCHIVE_EXISTED(822,"Bạn đã có mã giảm giá này!"),
